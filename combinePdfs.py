...
def selectFiles(pdfFilesBox):
    pdfFiles = pdfFilesBox #Lista que guardará os nomes de todos os arquivos PDF selecionados pelo usuário
...
pdfFilesBox = é uma lista que armazena os arquivos escolhidos pelo usuário de determinado diretório
'''
